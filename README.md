...
- necesário obter a .env do projeto
...
- Página de Registro
    ...
    botão 'Criar conta' para concluir registro de usuário e acessar a página principal.
    botão 'Voltar ao login' para voltar à tela de login
